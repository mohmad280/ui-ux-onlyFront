    ...
    <div className="glow-card group overflow-hidden">
      ...
      <div className="relative overflow-hidden bg-gray-100">
        {thumbnail && !imageError ? (
          ...
          <div className="w-full h-48 flex items-center justify-center bg-gradient-to-br from-purple-50 to-glowPurple/20">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="w-8 h-8 bg-gradient-to-r from-purple-600 to-glowPurple rounded-full flex items-center justify-center text-white text-xs font-bold">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => onView(id)}
              className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-purple-100 rounded-lg hover:bg-purple-50 hover:shadow-glow-purple transition-all duration-200 transform hover:scale-105 flex items-center gap-2"
            >
              <svg
                className="w-4 h-4"
                fill="none"
